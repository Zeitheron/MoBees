...
public class ContainerAlvearyFrameHousing
		extends ContainerTile<TileAlvearyFrameHousing>
{
	
	public static ContainerAlvearyFrameHousing fromNetwork(int windowId, Inventory inv, FriendlyByteBuf data)
	{
		TileAlvearyFrameHousing tile = TileUtil.getTile(inv.player.getLevel(), data.readBlockPos(), TileAlvearyFrameHousing.class);
